...
// URLs de Transmissão Praise FM Brasil
...
// Helper para fuso horário de Brasília (UTC-3)
...
const AppContent: React.FC = () => {
  ...
  // Identifica se estamos em uma rota que deve ocultar elementos de navegação comuns
  const isAppView = location.pathname === '/app';
  const isAuthView = ['/login', '/signup', '/terms'].includes(location.pathname);
  ...
  return (
    <div className="min-h-screen flex flex-col pb-[120px] bg-white text-black dark:bg-[#121212] dark:text-white transition-colors duration-300">
      ...
      {/* Navbar não aparece na View do App nem em Telas de Auth Brutalistas */}
      ...
      {/* Footer e Player Bar ocultos na View do App e Auth */}
