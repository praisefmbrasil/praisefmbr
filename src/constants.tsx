...
const IMAGES = {
  ...
  FELIPE_SANTOS: 'https://res.cloudinary.com/dlcliu2cv/image/upload/v1778892293/patick_silva_r4lpvp.webp',
  THIAGO_MOREIRA: 'https://res.cloudinary.com/dlcliu2cv/image/upload/v1778892292/cesar_brum_auudhy.webp',
...
const commonDaily: Program[] = [
  ...
  { id: '6', title: 'Praise FM Nova Geração', host: 'Ana Paula', startTime: '17:00', endTime: '18:00', description: 'Descubra os novos talentos da música cristã.', image: IMAGES.ANA_PAULA },
  { id: '7', title: 'De Carona com a Praise FM', host: 'Bruno Almeida', startTime: '18:00', endTime: '20:00', description: 'Sua companhia no trânsito e na volta para casa.', image: IMAGES.BRUNO_ALMEIDA },
  { id: '9', title: 'Praise FM Pop', host: 'Thiago Moreira', startTime: '20:00', endTime: '21:00', description: 'Os maiores sucessos do pop gospel contemporâneo.', image: IMAGES.THIAGO_MOREIRA },
...
export const SCHEDULES: Record<number, Program[]> = {
  ...
  0: [
    ...
    { id: 's6', title: 'Praise FM Nova Geração', host: 'Ana Paula', startTime: '17:00', endTime: '18:00', description: 'Novidades do mundo gospel.', image: IMAGES.ANA_PAULA },
    { id: 's7', title: 'Worship Brasil', host: 'Equipe Praise FM', startTime: '18:00', endTime: '20:00', description: 'Noite de adoração.', image: IMAGES.WORSHIP_BR },
    { id: 's8', title: 'Praise FM Pop', host: 'Thiago Moreira', startTime: '20:00', endTime: '21:00', description: 'O melhor do pop cristão.', image: IMAGES.THIAGO_MOREIRA },
    { id: 's9', title: 'Praise FM Clássicos', host: 'Rodrigo Veras', startTime: '21:00', endTime: '22:00', description: 'Relíquias da música gospel.', image: IMAGES.RODRIGO_VERAS },
    { id: 's10', title: 'Pregação da Palavra', host: 'Pastores Convidados', startTime: '22:00', endTime: '23:00', description: 'Uma palavra de fé para sua semana.', image: IMAGES.PREGACAO },
    { id: 's11', title: 'Worship Brasil', host: 'Equipe Praise FM', startTime: '23:00', endTime: '00:00', description: 'Terminando o domingo em oração.', image: IMAGES.WORSHIP_BR },
  ]
};
