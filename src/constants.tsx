...
const IMAGES = {
  ...
  PATRICK_SILVA: 'https://res.cloudinary.com/dlcliu2cv/image/upload/v1782434156/patrick-silva_mzkmpr.webp',
...
const commonDaily: Program[] = [
  ...
  { id: '2',  title: 'Worship',               host: 'Praise FM',      startTime: '06:00', endTime: '07:00', description: 'O melhor da adoração nacional e internacional.', image: IMAGES.WORSHIP        },
  ...
  { id: '4',  title: 'Worship',               host: 'Praise FM',      startTime: '12:00', endTime: '13:00', description: 'Momento de adoração ao meio-dia.',               image: IMAGES.WORSHIP        },
  ...
  { id: '11', title: 'Worship',               host: 'Praise FM',      startTime: '22:00', endTime: '00:00', description: 'Encerrando o dia na presença do Senhor.',        image: IMAGES.WORSHIP        },
];
...
export const SCHEDULES: Record<number, Program[]> = {
  ...
  0: [
    ...
    { id: 's2',  title: 'Worship',               host: 'Praise FM',          startTime: '06:00', endTime: '07:00', description: 'Iniciando o domingo em adoração.',              image: IMAGES.WORSHIP        },
    ...
    { id: 's4',  title: 'Worship Brasil',        host: 'Praise FM',          startTime: '12:00', endTime: '13:00', description: 'Louvor ao meio-dia.',                           image: IMAGES.WORSHIP        },
    ...
    { id: 's8',  title: 'Worship',               host: 'Praise FM',          startTime: '18:00', endTime: '20:00', description: 'Noite de adoração.',                            image: IMAGES.WORSHIP        },
    ...
    { id: 's11', title: 'Worship',               host: 'Praise FM',          startTime: '22:00', endTime: '00:00', description: 'Terminando o domingo em oração.',               image: IMAGES.WORSHIP        },
  ]
};