...
// Formatação para 24h (Padrão Brasil)
    ...
    <section ref={listContainerRef} className="bg-white dark:bg-[#000] min-h-screen font-sans transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 py-20">
        ...
        <div className="flex flex-col md:flex-row md:items-baseline md:space-x-4 mb-12 border-b-4 border-black dark:border-white pb-6">
          ...
          <p className="text-gray-400 font-bold uppercase tracking-wide text-sm mt-4 md:mt-0">
        ...
        <div className="sticky top-16 z-[40] bg-white/95 dark:bg-black/95 backdrop-blur-md border-b border-gray-100 dark:border-white/5 py-4 mb-16 -mx-4 px-4 sm:mx-0 sm:px-0">
          <div className="flex items-center space-x-6 text-[11px] font-bold uppercase tracking-wide overflow-x-auto no-scrollbar">
        ...
        {(Object.entries(sections) as [string, Program[]][]).map(([title, items]) => (
          items.length > 0 && (
            <div key={title} id={title} className="mb-20 scroll-mt-32">
              <h3 className="text-xl font-bold dark:text-white mb-8 uppercase tracking-tight border-l-4 border-[#ff6600] pl-4">
                {title}
              </h3>
                  ...
                  return (
                    ...
                    >
                      <div className="w-32 flex-shrink-0 flex flex-col mb-6 md:mb-0 pt-1">
                        ...
                        {active && (
                          <div className="mt-3 inline-flex items-center justify-center bg-[#ff6600] text-black text-[10px] font-bold px-3 py-1 uppercase tracking-wider w-24">
                            NO AR
                          </div>
                        )}
                      </div>
                      ...
                      <div className="flex-grow min-w-0 pt-1">
                        <h4 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white group-hover:text-[#ff6600] leading-tight tracking-tight mb-2 transition-all duration-300 uppercase">
                          {prog.title}
                        </h4>
                        <p className="text-gray-500 dark:text-gray-400 font-bold text-base mb-4 tracking-tight uppercase">
                          com {prog.host}
                        </p>
                        ...
                        {active && (
                          <div className="mt-6 flex items-center space-x-3">
                             ...
                             <span className="text-[10px] font-bold text-[#ff6600] uppercase tracking-wider">Ouvindo agora ao vivo</span>
                          </div>
                        )}
                      </div>
                    </div>
