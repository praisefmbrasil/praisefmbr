...
const SCHEDULE_BRASIL: Record<number, Program[]> = {
  0: [
    ...
    { id: 'br-d-2',  title: 'Worship',              host: '',               startTime: '06:00', endTime: '07:00', description: 'Louvor e adoração sem interrupção.',             image: IMG.WORSHIP },
    ...
    { id: 'br-d-4',  title: 'Worship',              host: '',               startTime: '12:00', endTime: '13:00', description: 'Louvor e adoração sem interrupção.',             image: IMG.WORSHIP },
    ...
    { id: 'br-d-8',  title: 'Worship',              host: '',               startTime: '18:00', endTime: '20:00', description: 'Louvor e adoração sem interrupção.',             image: IMG.WORSHIP },
    ...
    { id: 'br-d-11', title: 'Worship',              host: '',               startTime: '22:00', endTime: '00:00', description: 'Louvor e adoração sem interrupção.',             image: IMG.WORSHIP },
  ],
  ...Object.fromEntries(
    [1, 2, 3, 4, 5, 6].map((day) => [
      day,
      [
        ...
        { id: `br-${day}-2`,  title: 'Worship',              host: '',               startTime: '06:00', endTime: '07:00', description: 'Louvor e adoração sem interrupção.',            image: IMG.WORSHIP },
        ...
        { id: `br-${day}-4`,  title: 'Worship',              host: '',               startTime: '12:00', endTime: '13:00', description: 'Louvor e adoração sem interrupção.',            image: IMG.WORSHIP },
        ...
        { id: `br-${day}-7`,  title: 'Praise FM Flow',       host: 'Dj Patrick',     startTime: '17:00', endTime: '18:00', description: 'O flow do gospel contemporâneo.',               image: IMG.DJ_PATRICK },
        ...
        { id: `br-${day}-11`, title: 'Worship',              host: '',               startTime: '22:00', endTime: '00:00', description: 'Louvor e adoração sem interrupção.',            image: IMG.WORSHIP },
      ] as Program[],
    ])
  ),
};
