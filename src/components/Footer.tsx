        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 mb-12">
          <div className="col-span-2">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-sm font-normal">
              Sua casa para a melhor música de adoração, conteúdo devocional exclusivo e a nova geração de artistas cristãos. Curadoria diária para edificar o seu espírito.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-normal text-gray-400">
              <li>
                <a 
                  href="https://www.instagram.com/praisefm.br/" 
                  target="_blank" 
