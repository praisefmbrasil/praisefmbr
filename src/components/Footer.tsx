...
const Footer: React.FC = () => {
  ...
  const LOGO_URL = 'https://res.cloudinary.com/dlcliu2cv/image/upload/v1769206554/LOGOBRASL_aigm87.webp';
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 mb-12">
          <div className="col-span-2">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-sm font-normal">
              Sua casa para as melhores músicas de adoração do mundo, conteúdo devocional exclusivo e a próxima geração de artistas da fé. Curado diariamente para o seu espírito.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-normal text-gray-400">
              ...
              <li><a href="mailto:contato@praisefmbra.com.br" className="hover:text-[#ff6600] transition-colors">Contato Direto</a></li>
            </ul>
          </div>
          <div>
