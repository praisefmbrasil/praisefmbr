  ...
  useEffect(() => {
    const loadSavedHistory = async () => {
      ...
      try {
        ...
        console.error("Falha ao carregar histórico do DB", err);
      } finally {
        ...
        es.onmessage = async (event) => {
          ...
          try {
            ...
            if (streamTitle.includes(' - ')) {
              ...
              // ✅ Usa Cloudinary com placeholder brasileiro
              ...
              setHistoryGroups(prev => {
                ...
                supabase.from('program_history').insert([{
                  ...
                  label: "GRAVADO AO VIVO"
                   ...
                   if (error) console.error("Erro de sincronização:", error.message);
                });
