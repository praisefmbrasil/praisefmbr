...
// Formatação de hora para o padrão brasileiro (24h)
...
const ProgramDetail: React.FC<ProgramDetailProps> = ({ program, onBack, onViewSchedule, onListenClick, isPlaying }) => {
  ...
  // Carregar histórico do Supabase ao montar o componente
  useEffect(() => {
  ...
  // Conexão com metadados em tempo real
  useEffect(() => {
        ...
        es.onmessage = async (event) => {
          ...
          try {
            ...
            if (streamTitle.includes(' - ')) {
              ...
              const blocked = ['praise fm', 'comercial', 'vinheta', 'promo', 'identificação'].some(k => 
              ...
              setHistoryGroups(prev => {
                ...
                }]).match(() => console.debug("Sync error skip"));

                return newState;
              });
            }
          } catch (err) {
            console.error("Erro no parse dos metadados", err);
          }
        };
        es.onerror = () => {
          es.close();
    ...
    <div className="bg-[#121212] min-h-screen text-white font-sans transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 pt-8 pb-4">
        <button onClick={onBack} className="flex items-center text-gray-400 hover:text-white transition-colors group mb-6">
          ...
          <span className="text-[11px] font-medium uppercase tracking-[0.2em]">Voltar ao Início</span>
        </button>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-8">
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-medium mb-6 tracking-tighter uppercase text-white">Sobre o Programa</h2>
          ...
          <div className="lg:col-span-4 space-y-12">
            ...
            <div className="bg-[#1a1a1a] p-8">
               <h3 className="text-[10px] font-medium uppercase text-gray-500 tracking-[0.2em] mb-4">A Seguir</h3>
               {nextProgram ? (
