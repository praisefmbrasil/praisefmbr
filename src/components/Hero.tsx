...
// 1. Ajuste para o Horário de Brasília
const getBrazilInfo = () => {
  const now = new Date();
...
// 2. Formato 24h (mais comum no Brasil) ou 12h se preferir
const formatTime = (time24: string) => {
  return time24; // Mantendo 24h para o padrão brasileiro
};
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      <div className="text-[11px] font-normal mb-1">
                        ...
                        <span className="text-gray-400 font-normal">{formatTime(prog.startTime)} - {formatTime(prog.endTime)}</span>
                      </div>
