    ...
    <>
      ...
      >
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
          <h2 className="text-xl font-medium uppercase tracking-tighter text-black">Programação</h2>
          <button 
        ...
        <div className="flex-grow overflow-y-auto">
          <div className="flex items-center p-6 border-b border-gray-100 space-x-6 bg-gray-50/50">
            ...
            <div className="flex flex-col min-w-0 flex-grow">
              <div className="flex items-center space-x-2 mb-1">
                <span className="text-[10px] font-medium text-[#ff6600] uppercase tracking-widest">Ao Vivo Agora</span>
              </div>
          ...
          <div className="p-10 text-center">
            <p className="text-[10px] font-medium text-gray-300 uppercase tracking-widest">Fim da fila</p>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center flex-grow min-w-0 pr-4">
            ...
            <div className="flex flex-col min-w-0">
              <div className="flex items-center space-x-2">
                 ...
                 <span className="text-[12px] font-medium text-black leading-tight uppercase tracking-tighter">Praise FM BRA</span>
              </div>
