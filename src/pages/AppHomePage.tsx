...
const getBrazilTime = () => {
  const now = new Date();
  const brDate = new Date(now.toLocaleString('pt-BR', { timeZone: 'America/Sao_Paulo' }));
  return {
...
// Formatação 12h conforme o padrão do design original
...
const AppHomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black text-black dark:text-white pb-24">
      ...
      {/* Carrossel de Programas Ao Vivo */}
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-4 p-3 hover:bg-gray-50 dark:hover:bg-white/5 rounded-lg transition-colors cursor-pointer">
            ...
            <div className="flex-grow min-w-0">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 truncate">Música Cristã Contemporânea</p>
              <div className="mt-2 flex items-center space-x-2">
                ...
                <span className="text-xs text-gray-500 dark:text-gray-400 whitespace-nowrap">há 2h</span>
              </div>
            </div>
            <button 
          ...
          <div className="flex items-center space-x-3 flex-grow min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs opacity-70 truncate">
                {currentProgram?.host !== "Praise FM Brasil" ? `com ${currentProgram?.host}` : 'Transmitindo Ao Vivo'}
              </p>
            </div>
          </div>
          <button 
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white dark:bg-black border-t border-gray-200 dark:border-white/10 px-4 py-2 shadow-lg">
        <div className="flex items-center justify-around">
          <button onClick={() => navigate('/app')} className="flex flex-col items-center py-2 text-[#ff6600]">
          ...
          <button onClick={() => navigate('/music')} className="flex flex-col items-center py-2 text-gray-500 dark:text-gray-400">
            <svg className="w-6 h-6 mb-1" fill="currentColor" viewBox="0 0 24 24">
          ...
          <button onClick={() => navigate('/schedule')} className="flex flex-col items-center py-2 text-gray-500 dark:text-gray-400">
            <svg className="w-6 h-6 mb-1" fill="currentColor" viewBox="0 0 24 24">
          ...
          <button onClick={() => navigate('/my-sounds')} className="flex flex-col items-center py-2 text-gray-500 dark:text-gray-400">
            <svg className="w-6 h-6 mb-1" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/>
            </svg>
            <span className="text-xs font-semibold">Meus Sons</span>
          </button>
