...
const NEW_RELEASES_DATA: Release[] = [
  {
    ...
    title: 'Vitorioso És',
    image: 'https://is1-ssl.mzstatic.com/image/thumb/Music112/v4/44/7b/9d/447b9d9c-f94d-4d4b-700d-5c68f7639433/cover.jpg/800x800bb.jpg',
    previewUrl: '',
    isHot: true
  },
  {
    ...
    image: 'https://is1-ssl.mzstatic.com/image/thumb/Music126/v4/3d/8c/8b/3d8c8b4a-6f0a-4b9e-9d8b-4b9e9d8b4b9e/cover.jpg/800x800bb.jpg',
    previewUrl: '',
    isHot: true
  },
  {
    ...
    image: 'https://is1-ssl.mzstatic.com/image/thumb/Music116/v4/5a/8b/6c/5a8b6c4a-6f0a-4b9e-9d8b-4b9e9d8b4b9e/cover.jpg/800x800bb.jpg',
    previewUrl: ''
  },
  {
    id: 'nr4',
    artist: 'Aline Barros',
    title: 'Jeová Jireh',
    image: 'https://is1-ssl.mzstatic.com/image/thumb/Music126/v4/44/7b/9d/447b9d9c-f94d-4d4b-700d-5c68f7639433/cover.jpg/800x800bb.jpg',
    previewUrl: ''
  },
  {
    id: 'nr5',
  ...
  },
  {
    ...
    title: 'Me Atraiu',
    image: 'https://is1-ssl.mzstatic.com/image/thumb/Music112/v4/5a/8b/6c/5a8b6c4a-6f0a-4b9e-9d8b-4b9e9d8b4b9e/cover.jpg/800x800bb.jpg',
    previewUrl: ''
  }
];
    ...
    const fetchPreviews = async () => {
      const updated = await Promise.all(NEW_RELEASES_DATA.map(async (item) => {
        try {
          ...
          const res = await fetch(`https://itunes.apple.com/search?term=${searchTerm}&media=music&entity=song&limit=1&country=br`);
          ...
          console.debug("Erro ao buscar prévia para:", item.title);
        }
        return item;
      }));
      setReleases(updated);
    ...
    <div className="bg-white dark:bg-[#000] min-h-screen transition-colors duration-300">
      ...
      <div className="bg-black text-white relative overflow-hidden h-[70vh] flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 w-full">
          ...
          <h1 className="text-7xl md:text-[10rem] font-black uppercase tracking-tighter leading-[0.8] mb-8">Nova<br />Onda</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 py-24">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-16 border-b-2 border-black dark:border-white pb-8">
          <div className="flex items-center space-x-4 mb-6 md:mb-0">
            <h3 className="text-4xl font-black uppercase tracking-tighter dark:text-white">Esta Semana</h3>
            <span className="text-gray-400 font-bold uppercase tracking-widest text-sm pt-2">Jan 2026</span>
          </div>
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-40">
            ...
            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-400">Escaneando novos hinos...</p>
          </div>
        ) : (
        ...
        <div className="mt-32 border-t border-gray-100 dark:border-white/10 pt-16 flex flex-col md:flex-row items-start gap-20">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 flex-grow">
               ...
               <div className="space-y-2">
                 ...
                 <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Novas Entradas Semanais</p>
               </div>
               <div className="space-y-2">
                 <p className="text-3xl font-black uppercase tracking-tighter dark:text-white">100%</p>
                 <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Foco Cristão</p>
               </div>
               <div className="space-y-2">
